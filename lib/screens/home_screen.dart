...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title: Text('homeTitle'.tr(), style: const TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
        actions: [
          IconButton(
            icon: Icon(
      ...
      body: AnimatedSwitcher(
        ...
        child: transactions.isEmpty
            ? Center(child: Text('noTransactions'.tr(), style: const TextStyle(color: Colors.grey)))
            : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('totalBalance'.tr(), style: const TextStyle(color: Colors.white70, fontSize: 16)),
                    ...
                    const SizedBox(height: 30),
                    Text('lastMovements'.tr(), style: Theme.of(context).textTheme.titleMedium),
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          NavigationDestination(icon: const Icon(Icons.home), label: 'homeTitle'.tr()),
          NavigationDestination(icon: const Icon(Icons.bar_chart), label: 'summary'.tr()),
        ],
      ),
    );
  }
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: Text(
          ...
          style: TextStyle(fontWeight: FontWeight.bold, color: tx.isIncome ? Colors.green : Colors.red),
        ),
      ),
    );
  }
